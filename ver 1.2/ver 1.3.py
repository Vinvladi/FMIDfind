...
im1 = Image.open('007.png').convert("RGBA") # Работаем с базовым изображением, которое мы будем менять
...
im0 = Image.open('mask_circle.jpg').convert("L")  # замена переменной, скорей всего можно не конвертировать лишний раз
